...
//MIULER -----------------------------------------------------
SvgPanZoom.prototype.enablePreventMouseEvents = function() {
  this.options.preventMouseEventsDefault = true;
}
SvgPanZoom.prototype.disablePreventMouseEvents = function() {
this.options.preventMouseEventsDefault = false;
}
//MIULER -----------------------------------------------------
...
SvgPanZoom.prototype.getPublicInstance = function() {
  ...
  if (!this.publicInstance) {
    ...
    , isControlIconsEnabled: function() {return !!that.options.controlIconsEnabled}
      ...
      //MIULER -------------------------------------------------------------------------------
    , enablePreventMouseEvents: function() {that.options.preventMouseEventsDefault = true; return that.pi}
    , disablePreventMouseEvents: function() {that.options.preventMouseEventsDefault = false; return that.pi}
      //MIULER -------------------------------------------------------------------------------
